...
const UploadedProtocolDetailsSchema: Schema = new Schema(
  {
    ...
    file: { type: Schema.Types.ObjectId, ref: 'ProtocolDocument', required: true },
  },
  { timestamps: true }
);

export default mongoose.model<IUploadedProtocolDetails>('uploaded-protocol-details', UploadedProtocolDetailsSchema);
